...
public class Test_Adapter_Zh extends RecyclerView.Adapter implements View.OnClickListener{
    private Context context;
    private List<DataBean>dataBeans;

    public Test_Adapter_Zh(Context context ,List<DataBean> dataBeans1){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        itemView.setOnClickListener(Test_Adapter_Zh.this);
