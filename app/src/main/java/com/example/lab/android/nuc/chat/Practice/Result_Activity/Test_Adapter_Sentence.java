...
public class Test_Adapter_Sentence extends RecyclerView.Adapter implements View.OnClickListener {

   private  Context context;
   private List<DataBean> dataBeanList;
   public Test_Adapter_Sentence(Context context ,List<DataBean> dataBeans){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        itemView.setOnClickListener(Test_Adapter_Sentence.this);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position,List payloads) {
        ...
        if (payloads.isEmpty()){
            itemHolder.imageView1.setTag(position);
