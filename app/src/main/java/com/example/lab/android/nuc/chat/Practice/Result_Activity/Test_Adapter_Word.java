...
public class Test_Adapter_Word  extends RecyclerView.Adapter implements View.OnClickListener{
    private Context context;
    private List<DataBean> dataBeans;


    public Test_Adapter_Word(Context context,List<DataBean> dataBeans){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        itemView.setOnClickListener(Test_Adapter_Word.this);
