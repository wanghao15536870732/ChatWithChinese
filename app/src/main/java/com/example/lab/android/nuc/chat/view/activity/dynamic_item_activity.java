...
import com.example.lab.android.nuc.chat.view.adapter.manager.FullyGridLayoutManager;
...
public class dynamic_item_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_dynamic_item_activity );
    ...
    private void loadDate() {
        ...
        mLyAiTe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(dynamic_item_activity.this,AiTeActivity.class );
