...
public class HoverImageView extends ImageView{
    ...
    private void setup(AttributeSet attrs){
        if (attrs != null){
            ...
            borderColor = typedArray.getColor(R.styleable.RoundRectangleImageView_borderColor,borderColor);
            hoverColor = typedArray.getColor(R.styleable.RoundRectangleImageView_hoverColor,hoverColor);
            borderWidth = typedArray.getDimension(R.styleable.RoundRectangleImageView_borderwidth,borderWidth);
            typedArray.recycle();
        }
        borderPath = new Path();
        boundPath = new Path();
